...
<style>
	.container-login100{
		background-image:url(uploads/AF1QipO6DNZqg9GkLSYzJ9F5kI5ZSBJQaPPP2HQBIJqMw1600-h1000-k-no.jpeg)
	}
</style>
</head>
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="text" name="cne" required>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter rpassword">
						...
						<input class="input100" type="password" name="rcode" required>
						<span class="focus-input100" data-placeholder="Re-type Code"></span>
					</div>
